...
protected:
   ...
   */
  void publishPose();
  void publishCustomData(const ros::Time& timestamp);
  void publishIOData();
  ...
  urcl::vector6d_t target_moment_;
  urcl::vector6int32_t joint_modes_;
  double timestamp_;
  urcl::vector3d_t actual_tool_accelerometer_;
  urcl::vector6d_t qdd_target_;
  ...
  std::unique_ptr<realtime_tools::RealtimePublisher<arm_msgs::ManipulatorState>> custom_state_pub_;
